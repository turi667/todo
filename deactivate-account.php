            ...
            <?php if(!isset($_SESSION['username'])): ?>
                ...
                <?php else: ?>
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        ...
                        <button onclick="return confirm('Do you really want to deactivate your account?')" type="submit" name="deleteAccountBtn" class="btn btn-danger btn-block pull-right">
